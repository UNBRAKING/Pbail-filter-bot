...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7641491740').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/Mr_Pbail")
